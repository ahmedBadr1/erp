...
class ReportsController extends ApiController
{
    public function __construct()
    {
        ...
        $this->middleware('permission:sales.reports.index', ['only' => ['index']]);
        $this->middleware('permission:sales.reports.orders', ['only' => ['orders']]);
        $this->middleware('permission:sales.reports.sales', ['only' => ['sales']]);
    }
    ...
    public function sales(CashReportRequest $request)//
    {
