    ...
    <form method="POST" action="#" wire:submit.prevent="save" enctype="multipart/form-data">
        ...
        <x-grid  >
            ...
            <x-form.group name="category_id" cols="4">
                ...
                <x-input.select wire:model.lazy="category_id" :required="true" :options="$categories"
            ...
            <x-form.group name="currency_id" cols="4">
                ...
                <x-input.select wire:model.lazy="currency_id" :required="true" :options="$currencies"
