...
{{--        <svg  id="theme-toggle-light-icon" class="w-4 h-4 dark:hidden" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">--}}
...
{{--        </svg>--}}
{{--        <svg id="theme-toggle-dark-icon" class="w-4 h-4 hidden dark:block" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">--}}
...
<div>
    <a
        id="theme-switcher"
        class="flex items-center justify-center cursor-pointer w-8 h-8 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full" for="light-switch"        href="#"
        data-theme="light"
        x-bind:class="darkMode ? 'hidden': ''"
    ...
    <a
        id="theme-switcher"
        class="flex items-center justify-center cursor-pointer w-8 h-8 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full" for="light-switch"
        href="#"
        data-theme="dark"
