...
<div class="my-2 relative rounded-md shadow-sm">
    ...
    <input type="{{$type}}"
           ...
           class=" w-full px-4 py-2 appearance-none bg-transparent dark:bg-slate-800 border border-slate-500 dark:border-slate-600 rounded-md active:border-slate-500 {{ $class }}"
           value="{{ $value }}"
